...
class AdminAuthorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $message = 'Hi, your account is created successfully and now you can login to our system from 
        the front end login page. Please go to this link: <br>';
        $message .= '<a href="'.route('login').'">';
        $message .= 'Click on this link';
        $message .= '</a>';
        $message .= '<br><br>Please see you password here and after login, change that immediately: <br>';
    ...
    public function update(Request $request,$id)
    {
        ...
        return redirect()->route('admin_author_show')->with('success','Data is created successfully.');
    }
