                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group mb-3">
                                        ...
                                        name="terms_title" value="{{ $row->terms_title }}">
                                    </div>
                                
                                    <div class="form-group mb-3">
                                        <label>Detail *</label>
                                        <textarea name="terms_detail"  class="form-control snote" id="" cols="30" rows="10">
                                            {{ $row->terms_detail }}
                                        </textarea>
                                    </div>
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="terms_status" class="form-control">
                                            <option value="Show" @if($row->terms_status == 'Show') 
                                                selected @endif>Show</option> 
                                            <option value="Hide" @if($row->terms_status == 'Hide') 
