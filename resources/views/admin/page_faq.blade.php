                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group mb-3">
                                ...
                                name="faq_title" value="{{ $row->faq_title }}">
                            </div>
                        
                            <div class="form-group mb-3">
                                <label>Detail *</label>
                                <textarea name="faq_detail"  class="form-control snote" id="" cols="30" rows="10">
                                    {{ $row->faq_detail }}
                                </textarea>
                            </div>
                            <div class="form-group mb-3">
                                ...
                                <select name="faq_status" class="form-control">
                                    <option value="Show" @if($row->faq_status == 'Show') 
                                        selected @endif>Show</option> 
                                    <option value="Hide" @if($row->faq_status== 'Hide') 
