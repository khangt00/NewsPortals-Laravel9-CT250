                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group mb-3">
                                        ...
                                        name="privacy_title" value="{{ $row->privacy_title }}">
                                    </div>
                                
                                    <div class="form-group mb-3">
                                        <label>Detail *</label>
                                        <textarea name="privacy_detail"  class="form-control snote" id="" cols="30" rows="10">
                                            {{ $row->privacy_detail }}
                                        </textarea>
                                    </div>
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="privacy_status" class="form-control">
                                            <option value="Show" @if($row->privacy_status == 'Show') 
                                                selected @endif>Show</option> 
                                            <option value="Hide" @if($row->privacy_status == 'Hide') 
