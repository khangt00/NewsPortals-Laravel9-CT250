                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group mb-3">
                                    ...
                                    name="disclaimer_title" value="{{ $row->disclaimer_title }}">
                                </div>
                            
                                <div class="form-group mb-3">
                                    <label>Detail *</label>
                                    <textarea name="disclaimer_detail"  class="form-control snote" id="" cols="30" rows="10">
                                        {{ $row->disclaimer_detail }}
                                    </textarea>
                                </div>
                                <div class="form-group mb-3">
                                    <label>Status *</label>
                                    <select name="disclaimer_status" class="form-control">
                                        <option value="Show" @if($row->disclaimer_status == 'Show') 
                                            selected @endif>Show</option> 
                                        <option value="Hide" @if($row->disclaimer_status == 'Hide') 
