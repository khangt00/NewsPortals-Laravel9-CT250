                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            name="contact_title" value="{{ $row->contact_title }}">
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="contact_map"  class="form-control " cols="30" rows="10" style="height:120px;">
                                {{ $row->contact_map }}
                            </textarea>
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <select name="contact_status" class="form-control">
                                <option value="Show" @if($row->contact_status == 'Show') 
                                    selected @endif>Show</option> 
                                <option value="Hide" @if($row->contact_status == 'Hide') 
