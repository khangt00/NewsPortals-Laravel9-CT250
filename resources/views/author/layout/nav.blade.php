...
<nav class="navbar navbar-expand-lg main-navbar">
    ...
    <ul class="navbar-nav navbar-right w-100-p justify-content-end">
        ...
        <li class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle" role="button" data-bs-toggle="dropdown" aria-expanded="flase">
                <img alt="image" src="{{ asset('uploads/'.Auth::guard('author')->user()->photo) }}" class="rounded-circle">
                <div class="d-sm-none d-lg-inline-block">{{ Auth::guard('author')->user()->name }}</div>
            </a>
            
            <ul class="dropdown-menu dropdown-menu-light">
                <li><a class="dropdown-item" href="{{ route('author_profile')}}"><i class="far fa-user"></i> Edit Profile</a></li>
